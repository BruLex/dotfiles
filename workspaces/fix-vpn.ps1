...
Write-Output ([string]::Format("nameserver 8.8.8.8")) | Add-Content -Path $ResolvConfFile
Write-Output ([string]::Format("nameserver 8.8.4.4")) | Add-Content -Path $ResolvConfFile
